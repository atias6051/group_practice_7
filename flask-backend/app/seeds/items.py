...
def seed_items():
    item1 = Item(
        ...
        image_url='https://images.unsplash.com/photo-1609845768806-767fcfc317b6?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1173&q=80.',
        name= 'pokemon1',
        price= randint(10, 20),
